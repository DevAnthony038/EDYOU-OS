...
# This script patches the gnome sessions for the target system.

print_ok "Setting up /usr/share/gnome-sessions/sessions..."
sed -i 's/Ubuntu/EDYOUOS/g' /usr/share/gnome-session/sessions/ubuntu.session
judge "Set up /usr/share/gnome-sessions/sessions"

print_ok "Setting up /usr/share/xsessions..."
rm /usr/share/xsessions/gnome* || true

mv /usr/share/xsessions/ubuntu.desktop /usr/share/xsessions/EDYOUOS.desktop
mv /usr/share/xsessions/ubuntu-xorg.desktop /usr/share/xsessions/EDYOUOS-xorg.desktop
sed -i 's/Name=Ubuntu/Name=EDYOUOS/g' /usr/share/xsessions/EDYOUOS.desktop
sed -i 's/Name=Ubuntu/Name=EDYOUOS/g' /usr/share/xsessions/EDYOUOS-xorg.desktop
judge "Set up /usr/share/xsessions"

print_ok "Setting up /usr/share/wayland-sessions..."
rm /usr/share/wayland-sessions/gnome* || true

mv /usr/share/wayland-sessions/ubuntu.desktop /usr/share/wayland-sessions/EDYOUOS.desktop
mv /usr/share/wayland-sessions/ubuntu-wayland.desktop /usr/share/wayland-sessions/EDYOUOS-wayland.desktop
sed -i 's/Name=Ubuntu/Name=EDYOUOS/g' /usr/share/wayland-sessions/EDYOUOS.desktop
sed -i 's/Name=Ubuntu/Name=EDYOUOS/g' /usr/share/wayland-sessions/EDYOUOS-wayland.desktop
