...
# | Thai                | `th`, `th_TH`                                                             | Noto Sans Thai         | Noto Serif Thai        | Cascadia Code                                  | `lang=th`, prepend-strong: use Thai fonts; code blocks â†’ Cascadia Code                 |
# | Arabic              | `ar`, `ar_SA`                                                             | Noto Naskh Arabic      | Noto Naskh Arabic      | Cascadia Code                                  | `lang=ar`, prepend-strong: use Naskh Arabic; code blocks â†’ Cascadia Code               |
